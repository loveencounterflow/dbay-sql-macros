(function() {
  'use strict';
  var DBay_sqlm_TOBESPECIFIED_error, DBay_sqlm_arity_error, DBay_sqlm_duplicate_parameters_error, DBay_sqlm_error, DBay_sqlm_internal_error, DBay_sqlm_unknown_macro_error, DBay_sqlm_unknown_parameters_error, DBay_sqlx, GUY, alert, debug, echo, equals, help, info, inspect, log, plain, praise, rpr, rx, sql_lexer, urge, warn, whisper,
    indexOf = [].indexOf;
