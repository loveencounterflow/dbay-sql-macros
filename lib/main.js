(function() {
  ...
  DBay_sqlx = class DBay_sqlx { // extends ( require H.dbay_path ).DBay
    ...
    declare(sqlx) {
      ...
      //.......................................................................................................
      current_idx = (ref1 = parameters_re != null ? parameters_re.lastIndex : void 0) != null ? ref1 : cfg.name_re.lastIndex;
    ...
    _get_cmd_re() {
      ...
      names = (Object.keys(this._declarations)).sort(function(a, b) {
      ...
      return this._cmd_re = RegExp(`(?<=\\W|^)(?<name>${names})(?=\\W|$)(?<tail>.*)$`, "g");
    }
      ...
      while (true) {
        ...
        sql_after = sql_before.replace(this._get_cmd_re(), (..._matches) => {
          ...
          for (idx = i = 0, len = ref2.length; i < len; idx = ++i) {
            parameter = ref2[idx];
            value = values[idx];
            R = R.replace(RegExp(`${parameter}\\b`, "g"), value);
          }
          return R + tail;
        });
